error id: file:///E:/毕设/spingboot/src/main/java/com/example/controller/ViolationController.java:_empty_/ViolationService#userHandleViolation#
file:///E:/毕设/spingboot/src/main/java/com/example/controller/ViolationController.java
empty definition using pc, found symbol in pc: _empty_/ViolationService#userHandleViolation#
...
public class ViolationController {
    ...
    public Result userHandleViolation(@RequestBody Violation violation) {
        violationService.userHand@@leViolation(violation);
        return Result.success();
    }
