error id: file:///E:/毕设/spingboot/src/main/java/com/example/service/ViolationService.java
file:///E:/毕设/spingboot/src/main/java/com/example/service/ViolationService.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[232,8]
...
public v@@oid userHandleViolation(Violation violation) {
    User user = userMapper.selectByIdCar(violation.getOwnerId());
    Car car = carMapper.selectByPlate(violation.getPlate());
    ViolationId violationId = violationIdMapper.selectAllById(violation.getViolationid());
...
QDox parse error in file:///E:/毕设/spingboot/src/main/java/com/example/service/ViolationService.java