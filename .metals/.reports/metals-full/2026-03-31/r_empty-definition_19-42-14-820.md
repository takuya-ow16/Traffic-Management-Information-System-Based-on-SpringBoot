error id: file:///E:/毕设/spingboot/src/main/java/com/example/service/ViolationService.java:_empty_/violationMapper#
file:///E:/毕设/spingboot/src/main/java/com/example/service/ViolationService.java
empty definition using pc, found symbol in pc: _empty_/violationMapper#
...
public void userHandleViolation1(Violation violation) {
    ...
    if (points <= 0) {
        ...
        if (v@@iolationMapper.selectByOnweridCountSQU(violation.getOwnerId()) == 1) {
            user.setStatus("NOR");
        }
    }
