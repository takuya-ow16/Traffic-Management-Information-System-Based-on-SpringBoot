error id: file:///E:/毕设/spingboot/src/main/java/com/example/service/ViolationService.java:_empty_/ViolationId#
file:///E:/毕设/spingboot/src/main/java/com/example/service/ViolationService.java
empty definition using pc, found symbol in pc: _empty_/ViolationId#
...
public void userHandleViolation1(Violation violation) {
    User user = userMapper.selectByIdCar(violation.getOwnerId());
    Car car = carMapper.selectByPlate(violation.getPlate());
    Violat@@ionId violationId = violationIdMapper.selectAllById(violation.getViolationid());
