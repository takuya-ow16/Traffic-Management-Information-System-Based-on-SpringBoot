error id: file:///E:/毕设/spingboot/src/main/java/com/example/controller/AdminController.java:_empty_/AdminService#selectAll#
file:///E:/毕设/spingboot/src/main/java/com/example/controller/AdminController.java
empty definition using pc, found symbol in pc: _empty_/AdminService#selectAll#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 987
uri: file:///E:/毕设/spingboot/src/main/java/com/example/controller/AdminController.java
text:
```scala
