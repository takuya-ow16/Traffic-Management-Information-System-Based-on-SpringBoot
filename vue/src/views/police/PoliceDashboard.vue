  ...
  <div class="dashboard">
    ...
    <div class="quick-actions">
      <h3>数据速查</h3>
        <el-row :gutter="30">
          <el-col :span="6">
            <el-card shadow="hover" class="action-card" @click="navigateTo('/police/Vehicles')" :body-style="{ padding: '20px' }">
              <div style="display: flex; align-items: center; justify-content: space-between;">
                <div>
                  <div style="font-size: 14px; color: #6b7280; margin-bottom: 4px;">当前车辆总数量</div>
          ...
          <el-col :span="6">
            <el-card shadow="hover" class="action-card" @click="navigateTo('/police/violationManagement')" :body-style="{ padding: '20px' }">
              <div style="display: flex; align-items: center; justify-content: space-between;">
                <div>
                  <div style="font-size: 14px; color: #6b7280; margin-bottom: 4px;">当前违章总数量</div>
    ...
    <div class="quick-actions">
      ...
      <el-row :gutter="30">
        <el-col :span="6">
                     <el-card shadow="hover" class="action-card" @click="navigateTo('/police/roadCondition')">
             <div class="action-content">
               <el-icon :size="32" color="#059669"><View /></el-icon>
               <h4>实时监控</h4>
               <p>查看监控和路况数据</p>
             </div>
           </el-card>
        ...
        <el-col :span="6">
          <el-card shadow="hover" class="action-card" @click="navigateTo('/police/Vehicles')">
            <div class="action-content">
        ...
        <el-col :span="6">
          <el-card shadow="hover" class="action-card" @click="navigateTo('/police/violationManagement')">
            <div class="action-content">
        ...
        <el-col :span="6">
          <el-card shadow="hover" class="action-card" @click="navigateTo('/police/UserProfile')">
            <div class="action-content">
...
import { Monitor, VideoCamera, Warning, User, InfoFilled, CircleCheckFilled, TrendCharts, Cpu, Clock, FolderOpened, Setting, DataLine, Tickets, View, Van } from '@element-plus/icons-vue'
